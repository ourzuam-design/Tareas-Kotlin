...
fun main() {
    ...
    val p3 = Producto("Teclado.", 80.0, 2, 5) // Inicia en alerta
...
//Tema: Lógica de negocio — Control de stock y alertas
//
//Descripción: Una tienda necesita un sistema básico para controlar su inventario. El estudiante debe modelar los productos y la lógica de alertas.
//
//Requerimientos:
//
...
//precio: Double
//cantidad: Int
//cantidadMinima: Int (umbral de alerta)
//Agrega los siguientes métodos a la clase:
//estaEnStockCritico(): Boolean → retorna true si cantidad <= cantidadMinima
//calcularValorTotal(): Double → retorna precio * cantidad
//abastecer(unidades: Int) → suma unidades al stock
//vender(unidades: Int): Boolean → descuenta si hay suficiente stock; retorna false si no alcanza
//Crea una clase Inventario con una lista de productos y los métodos:
//agregarProducto(producto: Producto)
//productosEnAlerta(): List<Producto> → filtra los que están en stock crítico
//valorTotalInventario(): Double → suma el valor total de todos los productos
//reportar() → imprime un resumen en consola